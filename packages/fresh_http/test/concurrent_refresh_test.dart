...
void main() {
  group('Concurrent Refresh', () {
    test(
      'refreshToken is called exactly once '
      'when 3 parallel requests all get 401',
      () async {
    ...
    test(
        'requests arriving while refresh is in-flight '
        'await the same refresh', () async {
      var refreshCallCount = 0;
      final refreshCompleter = Completer<OAuth2Token>();
    ...
    test(
        ...
        'all requests complete without hanging', () async {
      var refreshCallCount = 0;
    ...
    test(
        'when refresh throws other exception '
        'state resets without hanging', () async {
      var refreshCallCount = 0;
